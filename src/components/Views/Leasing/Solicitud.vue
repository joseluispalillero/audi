           ...
           <!--Monto disponible-->
            ...
            <div class="formulario" v-show="mostrarSolicitud">
                ...
                <v-row>
                    <v-col  cols="12" sm="4"  md="4">
                        <v-text-field label="Modelo" ></v-text-field>
                    </v-col>
                    <v-col  cols="12"  sm="4"  md="4" >
            ...
            <div class="formulario" v-show="mostrarSolicitud">
                ...
                <v-row v-show="mostrarSolicitud">
                    ...
                    <v-col cols="12"  sm="3"  md="3"  >
                        <v-select :items="['Soltero', 'Casado', 'Divorciado', 'Separado', 'Viudo', 'Concubinato']" label="Estado civil aval"></v-select>
                    </v-col>
                    <v-col cols="12"  sm="6"  md="6"  >
                       <v-checkbox >
                ...
                <v-row v-show="mostrarSolicitud">
                    ...
                    <v-col  cols="12" sm="3"  md="3" >
                        <v-select :items="['Padre', 'Madre', 'Hermano', 'Hijo', 'Pareja', 'Cónyuge', 'Suegro(a)', 'Abuelo(a)']" label="Parentesco"></v-select>
                    </v-col>
                    <v-col  cols="12" sm="6"  md="6" >
                       <template>
                        ...
                        <template>
                            <div class="text-left">
                                ...
                                <v-card>
                                    ...
                                    <v-card-text>
                                        Escrituras de la propiedad que deja en garantía a nombre del aval (liberadas y sin ningún gravamen)
                                    </v-card-text>
                                    <v-card-text>
                                        Boleta de predial actual de la propiedad que deja en garantía a nombre del aval (el pago deberá indicar el valor catastral de la propiedad el cual debe ser igual o mayor al valor comercial del auto a solicitar)
                                    </v-card-text>
                                    <v-card-text>
                                        En caso de haber copropietarios del inmueble en garantía sólo se aceptará si están casados en sociedad conyugal debiendo proporcionar los siguientes documentos adicionales:
                                    </v-card-text>
                                    <v-card-text>
                        ...
                        <v-expansion-panel>
                            <v-expansion-panel-header>Carga de documentos</v-expansion-panel-header>
                             <v-expansion-panel-content>
                                ...
                                <v-row>
                                    <v-col  cols="12" sm="5"  md="5" >
                                        <v-card-text>Boleta de predial actual de la propiedad que deja en garantía a nombre del aval</v-card-text>
                                    </v-col>
                                    <v-col  cols="12" sm="2"  md="2" >
                                        <v-file-input label="Cargar archivo" outlined  dense ></v-file-input>
                                    </v-col>
