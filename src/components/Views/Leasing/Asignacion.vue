<template>
  <div id="container-usuarios">
    ...
    <div class="usuarios">
      ...
      <!--Modelos disponibles-->
      <div class="formulario" v-show="mostrarSolicitud" id="mostrarSolicitud">
        <v-row>
          <v-col cols="12">
        ...
        <v-row>
          <v-data-table :single-select="singleSelect" show-select v-model="selectedModelos" :headers="headersModelos"
                        :items="tabModelos" item-key="modVin" :items-per-page="3" class="elevation-1">
            <template v-slot:top>
            </template>
          </v-data-table>
        </v-row>
      ...
      <div class="formulario" v-show="mostrarSolicitud">
        ...
        <v-row>
          ...
          <v-col cols="12" sm="3" md="3">
            <v-text-field label="Fecha de inicio de contrato" prepend-icon="mdi-calendar" readonly
                          @click="dialogFechaIniC = true"></v-text-field>
          </v-col>
          <v-col cols="12" sm="3" md="3">
            <v-text-field label="Fecha fin de contrato" prepend-icon="mdi-calendar" readonly
                          @click="dialogFechaFinC = true"></v-text-field>
          </v-col>
          <v-col cols="12" sm="3" md="3">
...
export default {
  ...
  methods: {
    ...
    scrollToEnd: function() {    	
        ...
        var messages = this.$el.querySelector('#mostrarSolicitud')
