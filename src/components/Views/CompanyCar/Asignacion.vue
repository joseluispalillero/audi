      ...
      <div class="formulario">
        <v-form v-model="valid">
          <v-row>
            ...
            <v-col md="4" cols="12">
              <v-text-field ref="A1PrimeraOpcion" v-model="A1PrimeraOpcion" label="Primera opción" disabled
                            outlined></v-text-field>
            </v-col>
            <v-col md="4" cols="12">
              <v-text-field ref="A1SegundaOpcion" v-model="A1SegundaOpcion" label="Segunda opción" disabled
                            outlined></v-text-field>
            </v-col>
            ...
            <v-col md="4" cols="12" v-show="tipoGrupoPersona">
              <v-text-field ref="A2PrimeraOpcion" v-model="A2PrimeraOpcion" label="Primera opción" disabled
                            outlined></v-text-field>
            </v-col>
            <v-col md="4" cols="12" v-show="tipoGrupoPersona">
              <v-text-field ref="A2SegundaOpcion" v-model="A2SegundaOpcion" label="Segunda opción" disabled
                            outlined></v-text-field>
            </v-col>
            <v-col cols="12">
              <div class="TablesolicitudPendiente">
                <v-data-table :headers="headersAutos" :items="dessertsAutos" sort-by="VIN" hide-default-footer
                              class="elevation-1">
                  <template v-slot:top>
            ...
            <v-col cols="12">
              <div class="TableCars">
                <v-data-table :headers="headersCars" item-key="VIN" :single-select="singleSelect" show-select
                              v-model="selected" :items="dessertsCars" sort-by="VIN" hide-default-footer
                              class="elevation-1">
                  <template v-slot:top>
                  </template>
                  <template v-slot:no-data>
            ...
            <v-col md="4" cols="12">
              <v-text-field ref="Lugar" v-model="lugar" :rules="LugarRules" label="Lugar de entrega*" required
                            outlined></v-text-field>
            </v-col>
            <v-col md="4" cols="12">
              <v-text-field ref="hora" v-model="hora" :rules="HoraRules" label="Hora de entrega del auto*" required
                            outlined></v-text-field>
            </v-col>
            <v-col md="4" cols="12">
              <v-text-field label="Fecha de entrega del auto*" required :rules="dateFechaRules" v-model="FechaEntrega"
                            outlined prepend-icon="mdi-calendar" readonly @click="dialogFecha = true"></v-text-field>
            </v-col>
            <v-col md="4" cols="12">
