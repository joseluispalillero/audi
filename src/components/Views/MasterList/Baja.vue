<template>
  <div id="masterlist-baja">
    ...
    <div class="baja">
          ...
          <v-col class="col-xs-12 col-sm-10 col-md-10" cols="12">
            <v-row>
              <v-col class="col-xs-9 col-sm-9 col-md-9" cols="9">
                <v-text-field class="search" v-model="filter" label="Search" :rules="searchRules"
            ...
            <v-container>
              <v-row>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Fecha devolución" required :rules="IniContratoRules"
                                v-model="editedItem.fecha_devolucion" prepend-icon="mdi-calendar" readonly
                                @click="dialog1 = true"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="KM al devolver" required :rules="PlacaRules"
                                v-model="editedItem.km_devolver"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="KM excedente" required :rules="ContratoRules"
                                v-model="editedItem.km_excedente"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Costo kilometraje" required :rules="ContratoRules"
                                v-model="editedItem.costo_km"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Avalúo" required :rules="ContratoRules"
                                v-model="editedItem.avaluo"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field label="Fecha devolución" required :rules="IniContratoRules"
                                v-model="editedItem.fecha_avaluo" prepend-icon="mdi-calendar" readonly
                                @click="dialog1 = true"></v-text-field>
                </v-col>
                <v-col cols="12" sm="6" md="4">
      ...
      <v-dialog ref="dialogSeguro1" v-model="dialogSeguro1" :return-value.sync="editedItem.ini_seguro" persistent
                width="290px">
      ...
      <v-dialog ref="dialogSeguro" v-model="dialogSeguro" :return-value.sync="editedItem.fin_seguro" persistent
                width="290px">
      ...
      <v-dialog ref="dialogEntrega" v-model="dialogEntrega" :return-value.sync="editedItem.fecha_entrega" persistent
                width="290px">
      ...
      <v-dialog ref="dialogDev" v-model="dialogDev" :return-value.sync="editedItem.fecha_devolucion" persistent
                width="290px">
      ...
      <v-dialog ref="dialogAvaluo" v-model="dialogAvaluo" :return-value.sync="editedItem.fecha_avaluo" persistent
                width="290px">
